...
class RushWars(BaseCog):
    ...
    async def troop(self, ctx, troop_name: str, level=None):
        ...
        embed.add_field(name="<:RW_Level:625788888480350216> Level", value=level)
        embed.add_field(name="<:RW_Health:625786278058917898> Health", value=upd_stats[0])
        embed.add_field(name="<:RW_Damage:625786276938907659> Damage", value=upd_stats[1])
        embed.add_field(name="<:RW_DPS:625786277903466498> Damage per second", value=dps)
        embed.add_field(name="<:RW_Rarity:625783200983154701> Rarity", value=troop.Rarity)
        embed.add_field(name="<:RW_Count:625786275802382347> Squad Size", value=troop.Count)
        embed.add_field(name="<:RW_Space:625783199670206486> Space", value=troop.Space)
        embed.add_field(name="<:RW_Targets:625786278096535574> Targets", value=target)
        embed.add_field(name="<:RW_AttSpeed:625787097709543427> Attack Speed", value=f"{troop.AttSpeed}s")
        embed.add_field(name="<:RW_HQ:625787531664818224> HQ Level", value=troop.UnlockLvl)
